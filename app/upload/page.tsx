...
export default function Upload() {
  ...
  const validate = () => {
    ...
    if (!file) {
      ...
      setError({ type: "caption", message: "A cation is required" });
      isError = true;
    }
    return isError;
  };
        ...
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
          ...
          <div className="mt-8 md:flex gap-6">
            {!fileDisplay ? (
              <label
                htmlFor="fileInput"
                className="nd:mx-0 mx-auto mt-4 mb-6 flex flex-col items-center justify-center w-full max-w-[260px] h-[470px] text-center p-3 border-2 border-dashed border-gray-300 rounded-lg hover:bg-gray-100 cursor-pointer"
              >
            ...
            <div className="mt-4 mb-6">
              <div className="flex bg-[#F8F8F8] py-4 px-6">
                ...
                <div className="flex justify-end mzs-w-[130px] w-full h-full text-center my-auto">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-10 py2.5 mt-8 border text-[16px] text-white bg-[#F02C56] rounded-sm"
                >
                  {isUploading ? (
                    <BiLoaderCircle
                      className="animate-spin"

...
export default function TopNav() {
  ...
  //let으로 useState를 정의하는 경우 showMenu를 직접 바꿀 수도 있음
  ...
  //debounce: 주어진 함수를 일정 시간 후에 실행되도록 함으로써 반복 실행을 막음
  const handleSearchName = debounce(
    async (event: { target: { value: string } }) => {
      //검색 상자가 비었을 경우 그냥 array도 비움
  ...
  const goTo = () => {
    //업로드 하려는데 아직 로그인 안했으면 로그인 창으로 전환
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* md에서는 flex로 그 왜에서는 hidden으로 표시한다는 정의 */}
